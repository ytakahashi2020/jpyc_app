import { JPYC, SdkClient } from './sdks/packages/core/dist/src/index.js';

// Polygon Amoy上でJPYCトークンのテスト
async function testPolygonJPYC() {
  console.log('🔷 Polygon Amoyネットワーク上でJPYCテスト開始');
...
export { testPolygonJPYC, testTransfer };